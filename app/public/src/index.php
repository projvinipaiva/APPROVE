  ...
  <div class="englobaTudoHome">
    <div class="homeInfo">
        ...
        <div class="homeIndicator">
                <p class="indicatorP">SAIBA MAIS</p>
                <svg class="indicatorIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#ffffff" d="M201.4 374.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 306.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
            </div>
       
    </div>
            <div class="homeInfo1">
                <div class="carouselItem">
                <svg class="carouselSvgEscuro" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#0485D8" d="M0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zM188.3 147.1c-7.6 4.2-12.3 12.3-12.3 20.9l0 176c0 8.7 4.7 16.7 12.3 20.9s16.8 4.1 24.3-.5l144-88c7.1-4.4 11.5-12.1 11.5-20.5s-4.4-16.1-11.5-20.5l-144-88c-7.4-4.5-16.7-4.7-24.3-.5z"/></svg>
                    <div class="carouselText">
                        <p class="carouselH1Escuro">APRENDA AS MATÉRIAS MAIS COBRADAS NOS VESTIBULARES.</p>
                        <p class="carouselPEscuro">No Approve, você tem acesso a conteúdos focados nas matérias mais recorrentes nos vestibulares. Assim, você pode direcionar seus estudos para os tópicos mais importantes e garantir que está bem preparado para enfrentar os desafios dos vestibulares, aumentando suas chances de sucesso.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="homeInfo2">
                <div class="carouselItem">
                <svg class="carouselSvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#FFFFFF" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
                    <div class="carouselText">
                        <p class="carouselH1">REALIZE QUESTÕES E TREINE OS SEUS CONHECIMENTOS.</p>
                        <p class="carouselP">No Approve, você pode acessar uma vasta biblioteca de questões de diferentes disciplinas . A prática constante é essencial para o sucesso acadêmico, e aqui você encontrará recursos que permitem testar e reforçar seus conhecimentos.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="homeInfo3">
                <div class="carouselItem">
                <svg class="carouselSvgEscuro" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#0485D8" d="M64 64c0-17.7-14.3-32-32-32S0 46.3 0 64L0 400c0 44.2 35.8 80 80 80l400 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L80 416c-8.8 0-16-7.2-16-16L64 64zm406.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L320 210.7l-57.4-57.4c-12.5-12.5-32.8-12.5-45.3 0l-112 112c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L240 221.3l57.4 57.4c12.5 12.5 32.8 12.5 45.3 0l128-128z"/></svg>
                    <div class="carouselText">
                        <p class="carouselH1Escuro">VEJA SUAS ESTÁTISTICAS E AVALIE O SEU DESEMPENHO.</p>
                        <p class="carouselPEscuro">Acompanhar o seu progresso é fundamental para alcançar seus objetivos. No Approve, você pode visualizar estatísticas detalhadas sobre seu desempenho, porcentagem de acertos e evolução ao longo do tempo. Essas informações ajudam a identificar pontos fortes e fracos, permitindo uma avaliação precisa do seu aprendizado.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="homeInfo4">
                <div class="carouselItem">
                <svg class="carouselSvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="#FFFFFF" d="M353.8 54.1L330.2 6.3c-3.9-8.3-16.1-8.6-20.4 0L286.2 54.1l-52.3 7.5c-9.3 1.4-13.3 12.9-6.4 19.8l38 37-9 52.1c-1.4 9.3 8.2 16.5 16.8 12.2l46.9-24.8 46.6 24.4c8.6 4.3 18.3-2.9 16.8-12.2l-9-52.1 38-36.6c6.8-6.8 2.9-18.3-6.4-19.8l-52.3-7.5zM256 256c-17.7 0-32 14.3-32 32l0 192c0 17.7 14.3 32 32 32l128 0c17.7 0 32-14.3 32-32l0-192c0-17.7-14.3-32-32-32l-128 0zM32 320c-17.7 0-32 14.3-32 32L0 480c0 17.7 14.3 32 32 32l128 0c17.7 0 32-14.3 32-32l0-128c0-17.7-14.3-32-32-32L32 320zm416 96l0 64c0 17.7 14.3 32 32 32l128 0c17.7 0 32-14.3 32-32l0-64c0-17.7-14.3-32-32-32l-128 0c-17.7 0-32 14.3-32 32z"/></svg>   
                    <div class="carouselText">
                        <p class="carouselH1">COMPITA COM OUTROS ESTUDANTES E ATINJA O TOPO DO RANKING.</p>
                        <p class="carouselP">A competição saudável pode ser um grande motivador para o aprendizado. No Approve, você tem a chance de competir com outros estudantes, participando do ranking Essa dinâmica não só torna o estudo mais divertido e estimulante, mas também promove um espírito de superação e excelência.</p>
                    </div>
                </div>
            </div>
    
            <div class="footerHome">
                <p class="footerHomeP">APPROVE ® 2024 | <a class="footerHomeA" href="funcoes/termos.php">TERMOS DE USO</a></p>
            </div>
  </div>
