...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 13/10/2024 às 15:20
...
INSERT INTO `respostas_questionarios` (`usuario_id`, `questionario_id`) VALUES
(2, 4),
(4, 4),
(5, 4),
(7, 4),
...
ALTER TABLE `respostas_questionarios`
  ADD PRIMARY KEY (`usuario_id`,`questionario_id`),
  ADD KEY `questionario_id` (`questionario_id`);
...
--
ALTER TABLE `respostas_usuarios`
  MODIFY `resposta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1613;
